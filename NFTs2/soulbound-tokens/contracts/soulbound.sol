...
contract DriverLicense is ERC721, ERC721URIStorage, Ownable {
    ...
    function _beforeTokenTransfer(address from, address to, uint256) pure public {
        require(from == address(0) || to == address(0), "Not allowed to transfer token");
    }

    function _afterTokenTransfer(address from, address to, uint256 tokenId) public {
